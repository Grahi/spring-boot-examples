package net.testjpa.springboot.Springbootjpacrudexample;
...
@SpringBootTest(classes = SpringbootJpaCrudExampleApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
